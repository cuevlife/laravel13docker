...
<head>
    ...
    <title>Forgot Password - {{ config('app.name', 'SmartBill') }}</title>
            ...
            <div class="flex-1 flex flex-col justify-center">
                <div class="w-full max-w-sm mx-auto">
                    <div class="mb-12 text-center lg:text-left">
                        <h2 class="text-3xl font-black text-slate-900 dark:text-white uppercase tracking-tighter  leading-none">{{ __('Forgot Password') }}</h2>
                    ...
                    <form method="POST" action="{{ route('password.email') }}" class="space-y-10">
                        ...
                        <div class="text-center pt-4">
                            <a href="{{ route('login') }}" class="text-[10px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-[0.2em] hover:text-discord-green transition-colors">
                                <i class="bi bi-arrow-left mr-2"></i> {{ __('Back to Login') }}
                            </a>
                        </div>
                    </form>
                </div>
