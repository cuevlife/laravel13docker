...
<head>
    ...
    <title>Reset Password - {{ config('app.name', 'SmartBill') }}</title>
            ...
            <div class="flex-1 flex flex-col justify-center">
                <div class="w-full max-w-sm mx-auto">
                    <div class="mb-12 text-center lg:text-left">
                        <h2 class="text-3xl font-black text-slate-900 dark:text-white uppercase tracking-tighter  leading-none">{{ __('Reset Password') }}</h2>
                    ...
                    <form method="POST" action="{{ route('password.store') }}" class="space-y-10">
                        ...
                        <div class="relative group">
                            <label class="absolute -top-6 left-0 text-[10px] font-black text-slate-400 uppercase tracking-widest group-focus-within:text-discord-green transition-colors">{{ __('Email Address') }}</label>
                        ...
                        <!-- Password -->
                        <div class="relative group">
                            <label class="absolute -top-6 left-0 text-[10px] font-black text-slate-400 uppercase tracking-widest group-focus-within:text-discord-green transition-colors">{{ __('New Password') }}</label>
