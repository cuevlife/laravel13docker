    ...
    <div x-data="templateRegistry()" class="space-y-8 animate-in fade-in duration-700 pb-20">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-[9px] md:text-[10px] font-bold text-[#80848e] uppercase tracking-[0.2em] mt-1.5">Folder Prompt Configurations</p>
                </div>
            </div>
            ...
            <table class="w-full text-left whitespace-nowrap block sm:table">
                <thead class="hidden sm:table-header-group">
                    <tr class="border-b border-[#e3e5e8] dark:border-[#313338] text-[10px] uppercase font-black tracking-widest text-[#80848e] bg-transparent">
                        ...
                        <th class="px-6 py-4">Linked Folder</th>
                    ...
                    @forelse($templates as $template)
                        <tr class="block sm:table-row p-5 sm:p-0 hover:bg-[#e3e5e8]/30 dark:hover:bg-[#313338]/30 transition-colors group relative">
                            ...
                            <td class="flex items-center justify-between sm:table-cell px-0 py-2 sm:px-4 sm:py-4 mt-2 sm:mt-0">
                                <span class="sm:hidden text-[9px] font-black uppercase tracking-widest text-[#80848e]">Folder</span>
                                <div class="flex items-center gap-2">
                                    <i class="bi bi-briefcase w-4 h-4 text-[#5c5e66] dark:text-[#b5bac1] hidden sm:block"></i>
                            ...
                            <td class="absolute top-5 right-5 sm:static sm:table-cell sm:px-4 sm:py-4">
                                <div class="flex items-center justify-end gap-1.5 sm:gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                                    <a href="{{ \App\Support\WorkspaceUrl::current(request(), 'templates/' . $template->id . '/edit') }}" class="p-2 bg-white dark:bg-[#313338] rounded-xl text-[#5c5e66] dark:text-[#b5bac1] hover:text-[#1e1f22] dark:hover:text-white transition-all shadow-sm relative z-20">
                                    ...
                                    <button @click="deleteTemplate({{ $template->id }})" class="p-2 bg-white dark:bg-[#313338] rounded-xl text-[#5c5e66] dark:text-[#b5bac1] hover:text-discord-red transition-all shadow-sm relative z-20">
        ...
        <template x-teleport="body">
            <div x-show="modalOpen" x-cloak class="fixed inset-0 z-50 flex items-center justify-center sm:px-4 pb-0 sm:pb-10 pt-10 px-0">
                ...
                <div class="relative w-full max-w-md bg-white dark:bg-[#313338] rounded-t-[2.5rem] sm:rounded-xl shadow-2xl p-8 transform transition-all mt-auto sm:mt-0 max-h-[90vh] overflow-y-auto"
                    ...
                    <p class="text-[11px] text-[#5c5e66] dark:text-[#b5bac1] leading-relaxed mb-6 font-medium">Create a new schema to teach the AI what to extract from receipt images. You must link it to a pre-registered Folder.</p>
                    ...
                    <form @submit.prevent="submitForm" class="space-y-5">
                        ...
                        <div class="space-y-1.5 relative">
                            <label class="text-[10px] font-black text-[#5c5e66] dark:text-[#b5bac1] uppercase tracking-widest pl-2">Linked Folder *</label>
