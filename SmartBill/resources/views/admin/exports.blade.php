    ...
    <div class="space-y-4 pb-20">
        <section class="rounded-[1rem] border border-black/5 bg-white shadow-sm dark:border-white/10 dark:bg-[#2b2d31]">
            ...
            <div class="flex flex-wrap items-center justify-between gap-2 border-b border-[#e3e5e8] px-4 py-2.5 dark:border-[#313338] md:px-5">
                <a href="{{ $slipRoute }}" class="inline-flex h-8 items-center justify-center gap-2 rounded-[0.75rem] border border-[#e3e5e8] bg-white px-3 text-[9px] font-black uppercase tracking-[0.14em] text-[#5c5e66] transition hover:border-discord-green/30 hover:text-discord-green dark:border-[#313338] dark:bg-[#1e1f22] dark:text-[#b5bac1] dark:hover:border-discord-green/50 dark:hover:text-[#7fe0a2]">
                    <i data-lucide="arrow-left" class="h-3.5 w-3.5"></i>
                    Back to Slip
                </a>
                @if(($stats['matching_slips'] ?? 0) > 0)
                    <a href="{{ $downloadRoute }}" class="inline-flex h-8 items-center justify-center gap-2 rounded-[0.75rem] bg-[#162033] px-3 text-[9px] font-black uppercase tracking-[0.18em] text-white transition hover:bg-[#0f1727]">
                        <i data-lucide="download" class="h-3.5 w-3.5"></i>
                        Download Workbook
                    </a>
                @else
                    <span class="inline-flex h-8 items-center justify-center gap-2 rounded-[0.75rem] bg-[#d5d6d9] px-3 text-[9px] font-black uppercase tracking-[0.18em] text-white opacity-80 dark:bg-[#313338]">
                        <i data-lucide="download" class="h-3.5 w-3.5"></i>
                        No Matching Slips
                    </span>
                @endif
            ...
            <form method="GET" action="{{ $indexRoute }}" x-data="{ filtersOpen: {{ $hasAdvancedFilters ? 'true' : 'false' }} }" class="border-b border-[#e3e5e8] px-4 py-3 dark:border-[#313338] md:px-5 md:py-4">
                <div class="grid grid-cols-1 gap-3 xl:grid-cols-[minmax(0,1.6fr)_220px_220px_auto]">
                    <div class="relative">
                        <i data-lucide="search" class="absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-[#80848e]"></i>
                        <input type="text" name="q" value="{{ $activeFilters['q'] }}" placeholder="Search slip, profile, or collection" class="h-10 w-full rounded-[0.85rem] border border-[#e3e5e8] bg-[#f8fafb] pl-10 pr-3 text-sm font-bold text-[#162033] outline-none transition focus:border-discord-green focus:ring-2 focus:ring-discord-green/15 dark:border-[#313338] dark:bg-[#1e1f22] dark:text-white">
                    </div>
                    <div class="relative">
                        <select name="batch_id" class="h-10 w-full appearance-none rounded-[0.85rem] border border-[#e3e5e8] bg-[#f8fafb] px-3 text-sm font-bold text-[#162033] outline-none transition focus:border-discord-green focus:ring-2 focus:ring-discord-green/15 dark:border-[#313338] dark:bg-[#1e1f22] dark:text-white">
                    ...
                    <div class="relative">
                        <select name="workflow_status" class="h-10 w-full appearance-none rounded-[0.85rem] border border-[#e3e5e8] bg-[#f8fafb] px-3 text-sm font-bold text-[#162033] outline-none transition focus:border-discord-green focus:ring-2 focus:ring-discord-green/15 dark:border-[#313338] dark:bg-[#1e1f22] dark:text-white">
                    ...
                    <div class="flex flex-wrap items-center gap-2 xl:justify-end">
                        <button type="button" @click="filtersOpen = !filtersOpen" class="inline-flex h-9 items-center justify-center gap-2 rounded-[0.85rem] border border-[#e3e5e8] bg-white px-3 text-[10px] font-black uppercase tracking-[0.18em] text-[#5c5e66] transition hover:border-[#162033]/15 hover:text-[#162033] dark:border-[#313338] dark:bg-[#1e1f22] dark:text-[#b5bac1] dark:hover:border-white/20 dark:hover:text-white">
                        ...
                        <a href="{{ $indexRoute }}" class="inline-flex h-9 items-center justify-center gap-2 rounded-[0.85rem] border border-[#e3e5e8] bg-white px-3 text-[10px] font-black uppercase tracking-[0.18em] text-[#5c5e66] transition hover:border-rose-300 hover:bg-rose-50 hover:text-rose-500 dark:border-[#313338] dark:bg-[#1e1f22] dark:text-[#b5bac1] dark:hover:border-rose-500/50 dark:hover:bg-rose-500/10 dark:hover:text-rose-300">
                            <i data-lucide="filter-x" class="h-4 w-4"></i>
                            Clear
                        </a>
                        <button type="submit" class="inline-flex h-9 items-center justify-center gap-2 rounded-[0.85rem] bg-[#162033] px-3 text-[10px] font-black uppercase tracking-[0.18em] text-white transition hover:bg-[#0f1727]">
                ...
                <div x-show="filtersOpen" x-cloak class="mt-3 rounded-[0.95rem] border border-[#e3e5e8] bg-[#fbfcfc] p-3 dark:border-[#313338] dark:bg-[#1e1f22]">
                    <div class="grid grid-cols-1 gap-3 md:grid-cols-2 xl:grid-cols-[180px_180px_minmax(0,1fr)_minmax(0,1fr)_190px]">
                        <div>
                            <input type="text" name="date_from" value="{{ $activeFilters['date_from'] }}" data-export-date autocomplete="off" placeholder="From date" class="h-10 w-full rounded-[0.85rem] border border-[#e3e5e8] bg-white px-3 text-sm font-bold text-[#162033] outline-none transition focus:border-discord-green focus:ring-2 focus:ring-discord-green/15 dark:border-[#313338] dark:bg-[#2b2d31] dark:text-white">
                        </div>
                        <div>
                            <input type="text" name="date_to" value="{{ $activeFilters['date_to'] }}" data-export-date autocomplete="off" placeholder="To date" class="h-10 w-full rounded-[0.85rem] border border-[#e3e5e8] bg-white px-3 text-sm font-bold text-[#162033] outline-none transition focus:border-discord-green focus:ring-2 focus:ring-discord-green/15 dark:border-[#313338] dark:bg-[#2b2d31] dark:text-white">
                        </div>
                        <div class="relative">
                            <select name="template_id" class="h-10 w-full appearance-none rounded-[0.85rem] border border-[#e3e5e8] bg-white px-3 text-sm font-bold text-[#162033] outline-none transition focus:border-discord-green focus:ring-2 focus:ring-discord-green/15 dark:border-[#313338] dark:bg-[#2b2d31] dark:text-white">
                        ...
                        <div>
                            <input type="text" name="label" value="{{ $activeFilters['label'] }}" placeholder="Filter by label" class="h-10 w-full rounded-[0.85rem] border border-[#e3e5e8] bg-white px-3 text-sm font-bold text-[#162033] outline-none transition focus:border-discord-green focus:ring-2 focus:ring-discord-green/15 dark:border-[#313338] dark:bg-[#2b2d31] dark:text-white">
                        </div>
                        <div class="relative">
                            <select name="archive_scope" class="h-10 w-full appearance-none rounded-[0.85rem] border border-[#e3e5e8] bg-white px-3 text-sm font-bold text-[#162033] outline-none transition focus:border-discord-green focus:ring-2 focus:ring-discord-green/15 dark:border-[#313338] dark:bg-[#2b2d31] dark:text-white">
            ...
            <div class="grid gap-3 border-b border-[#e3e5e8] px-4 py-3 dark:border-[#313338] md:grid-cols-2 xl:grid-cols-4 md:px-5">
                <div class="rounded-[0.95rem] bg-[#f6faf7] px-3 py-3 dark:bg-[#1e1f22]">
            ...
            <div class="grid gap-3 px-4 py-3 md:px-5 lg:grid-cols-[minmax(0,1.6fr)_320px]">
                <section class="rounded-[1rem] border border-[#e3e5e8] p-4 dark:border-[#313338]">
                ...
                <section class="space-y-4">
                    <div class="rounded-[1rem] border border-[#e3e5e8] p-4 dark:border-[#313338]">
                        ...
                        <div class="mt-4">
                            @if(($stats['matching_slips'] ?? 0) > 0)
                                <a href="{{ $downloadRoute }}" class="inline-flex h-9 w-full items-center justify-center gap-2 rounded-[0.85rem] bg-[#162033] px-3 text-[10px] font-black uppercase tracking-[0.18em] text-white transition hover:bg-[#0f1727]">
                                    <i data-lucide="download" class="h-4 w-4"></i>
                                    Download Workbook
                                </a>
                            @else
                                <div class="inline-flex h-9 w-full items-center justify-center gap-2 rounded-[0.85rem] bg-[#d5d6d9] px-3 text-[10px] font-black uppercase tracking-[0.18em] text-white opacity-80 dark:bg-[#313338]">
                                    <i data-lucide="download" class="h-4 w-4"></i>
                                    No Data to Export
                                </div>
                            @endif
                    ...
                    <div class="rounded-[1rem] border border-[#e3e5e8] p-4 dark:border-[#313338]">
                        ...
                        <div class="mt-3 space-y-2.5">
                            @forelse($recentExports as $slip)
                                <div class="rounded-[0.85rem] bg-[#f8fafb] px-3 py-2.5 dark:bg-[#1e1f22]">
                            ...
                            @empty
                                <div class="rounded-[0.85rem] bg-[#f8fafb] px-3 py-3 text-sm font-bold text-slate-500 dark:bg-[#1e1f22] dark:text-slate-300">No exported slips yet.</div>
                            @endforelse
                        </div>
                    </div>
                </section>
