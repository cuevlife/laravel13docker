<header class="h-16 bg-[#fafafa] dark:bg-[#1e1f22] items-center justify-between px-8 border-b border-[#e3e5e8]/50 dark:border-[#313338]/50 z-20 flex transition-colors">
    @php
